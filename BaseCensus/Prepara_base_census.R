...
# FinalWeight - contínuo
# Education - ordnial
# EducationNum - discreto
# MaritalStatus - nominal
# Occupation - nominal
# Relationship - nominal
# Race - nominal
# sex - nominal
# capitalgain - contínua
# capitalloss - contínua
# hoursperweek - discreta
# country - nominal
# income - discreta (pós transformações)
...
classificador = naiveBayes(x = base_treinamento[,-15],y = base_treinamento[,15])
print(classificador)
previsoes = predict(classificador,base_teste[,-15])
print(previsoes)
...
# 0,8214 utilizando encoding + escalonamento
