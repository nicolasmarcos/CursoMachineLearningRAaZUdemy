...
setwd("/media/n/6DEFCED45A78BAB8/workspace/Udemy/MachineLearningR/BaseCensus")


# Cenário 1: acurácia da árvore com categorização + escalonamento
...
set.seed(1)
classificador = randomForest(x = base_treinamento[,-15], y = base_treinamento$income, ntree = 100)
print(classificador)
plot(classificador)
...
# Cenário 2: acurácia da árvore com categorização 
...
# Cenário 3: acurácia da árvore com escalonamento
...
# Cenário 4: acurácia da árvore sem pré-processamento
...
# 0.8583  - Cenário 1: acurácia da árvore com categorização + escalonamento
# 0.8565 - Cenário 2: acurácia da árvore com categorização 
# 0.8583 - Cenário 3: acurácia da árvore com escalonamento
# 0.8565 - Cenário 4: acurácia da árvore sem pré-processamento